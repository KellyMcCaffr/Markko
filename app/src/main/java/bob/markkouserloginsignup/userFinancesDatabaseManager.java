...
public class userFinancesDatabaseManager extends SQLiteOpenHelper {
    private static final int DARABASE_VERSION=1;
    private static final String DATABASE_NAME="userfin.db";
    private static final String TABLE_PRODUCTS="userfin";
    ...
    userFinancesDatabaseManager(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    void addAccount(String businessIdentifier,String cardType,
    ...
    public void deleteAccount(String businessIdentifier){
     ...
     String getAccountInfoByUsername(String enteredUsername){
        SQLiteDatabase db=getWritableDatabase();
